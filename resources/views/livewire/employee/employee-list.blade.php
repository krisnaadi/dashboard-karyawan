                ...
                <form wire:submit.prevent="save">
                    <div class="relative w-auto pb-8">
                        <label class="form-control w-full">
                            ...
                            <input wire:model="form.name" type="text" placeholder="Input nama karyawan"
                        ...
                        <label class="form-control w-full">
                            ...
                            <input wire:model="form.username" type="text" placeholder="Input username karyawan"
                                class="input input-bordered w-full" />
                            @error('form.username')
                                <div class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                        ...
                        <label class="form-control w-full">
                            ...
                            <input wire:model="form.password" type="password" placeholder="Input password"
                                class="input input-bordered w-full" />
                            @error('form.password')
                                <div class="label">
                                    <span class="label-text-alt text-error">{{ $message }}</span>
                        ...
                        <label class="form-control w-full">
                            ...
                            <input wire:model="form.password_confirmation" type="password" placeholder="Ulangi password"
                                class="input input-bordered w-full" />
                        ...
                        <label class="form-control w-full">
                            ...
                            <select wire:model="form.unit_id" class="select select-bordered">
                        ...
                        <label class="form-control w-full">
                            ...
                            <input wire:model="form.join_date" type="date" placeholder="Input nama unit"
                                class="input input-bordered w-full" />
